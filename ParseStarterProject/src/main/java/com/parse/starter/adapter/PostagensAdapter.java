...
public class PostagensAdapter extends ArrayAdapter<ParseObject> {

    private Context context;
    private List<ParseObject> postagens;

    public PostagensAdapter(Context context, List<ParseObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(postagens.size()>0){
            ...
            Picasso.with(context).load(parseObject.getParseFile("imagem").getUrl()).into(imagemPostagem);
        }
